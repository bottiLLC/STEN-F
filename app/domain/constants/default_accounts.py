...
DEFAULT_ACCOUNTS = [
    ...
    },
    {
        ...
        "name": "有価証券",
        "type": AccountType.CURRENT_ASSET,
        "description": "売買目的の有価証券",
    },
    {
        "code": "1150",
        "name": "仮払金",
        "type": AccountType.CURRENT_ASSET,
        "description": "使途不明の支出など",
    },
    {
        "code": "1160",
        "name": "前払費用",
        "type": AccountType.CURRENT_ASSET,
        "description": "継続的役務提供の前払い",
    },
    # 2. 固定資産 (Fixed Assets)
    {
        "code": "1210",
        ...
        "description": "店舗、事務所、倉庫など",
    },
    {
        "code": "1220",
        "name": "構築物",
        "type": AccountType.FIXED_ASSET,
        "description": "塀、舗装、看板など",
    },
    {
        "code": "1230",
        "name": "車両運搬具",
    ...
    # Actually, let's map them to DEFERRED_ASSET as it exists in the system.
    {
        "code": "1310",
        "name": "創立費",
        "type": AccountType.DEFERRED_ASSET,
        "description": "会社設立時の費用",
    },
    {
        "code": "1320",
        "name": "開業費",
        "type": AccountType.DEFERRED_ASSET,
        "description": "営業開始までの費用",
    },
    # 3. 流動負債 (Current Liabilities)
    {
        ...
        "description": "1年以内に返済する借入金",
    },
    {
        "code": "2120",
        "name": "未払金",
        "type": AccountType.CURRENT_LIABILITY,
        "description": "本来の営業取引以外の未払い",
    },
    {
        "code": "2130",
        "name": "預り金",
        "type": AccountType.CURRENT_LIABILITY,
        "description": "源泉税、社会保険料の預かり区分",
    },
    {
        "code": "2140",
        "name": "仮受金",
    ...
    },
    {
        ...
        "name": "旅費交通費",
        "type": AccountType.SGA,
        "description": "電車代、バス代、宿泊費など",
    },
    {
        "code": "6140",
        "name": "通信費",
        "type": AccountType.SGA,
        "description": "電話代、インターネット代、切手代",
    },
    {
        "code": "6150",
        "name": "水道光熱費",
    ...
    },
    {
        ...
        "name": "地代家賃",
        "type": AccountType.SGA,
        "description": "事務所の家賃など",
    },
    {
        "code": "6170",
        "name": "消耗品費",
        "type": AccountType.SGA,
        "description": "10万円未満の物品購入",
    },
    {
        "code": "6180",
        "name": "接待交際費",
        "type": AccountType.SGA,
        "description": "取引先との飲食代、贈答品など",
    },
    {
        "code": "6190",
        "name": "租税公課",
        "type": AccountType.SGA,
        "description": "固定資産税、印紙代など",
    },
    {
        "code": "6200",
        "name": "支払手数料",
    ...
    },
    {
        ...
        "name": "繰越利益剰余金",
        "type": AccountType.EQUITY,
        "description": "過去の利益の蓄積",
    },
    {
        "code": "9110",
        "name": "法人税、住民税及び事業税",
        "type": AccountType.TAXES,
        "description": "法人税、住民税及び事業税",
    },
]
