            ...
            rx.foreach(
                ...
                lambda line, i: rx.hstack(
                    rx.select.root(
                        ...
                        on_change=lambda val: JournalFormState.update_line_account(
                            i, val
                        ),
                    ),
                    rx.input(
                        ...
                        on_change=lambda val: JournalFormState.update_line(
                            i, "debit", val
                        ),
                        width="150px",
                    ),
                    ...
                    rx.button(
                        ...
                        disabled=JournalFormState.lines.length() <= 1,  # type: ignore
                    ),
                    width="100%",
                    align_items="center",
                ),
