            ...
            rx.vstack(
                ...
                rx.hstack(
                    rx.vstack(
                        ...
                        rx.divider(),
                        rx.hstack(
                            rx.text("資産合計", weight="bold"),
                            rx.spacer(),
                            rx.text(
                                f"{ReportsState.financial_report.total_assets:,}",
                                weight="bold",
                            ),
                            width="100%",
                        ),
                    ...
                    rx.vstack(
                        ...
                        render_section(
                            ReportsState.financial_report.current_liabilities
                        ),
                        render_section(ReportsState.financial_report.fixed_liabilities),
                        rx.divider(),
                        rx.hstack(
                            rx.text("負債合計", weight="bold"),
                            rx.spacer(),
                            rx.text(
                                f"{ReportsState.financial_report.total_liabilities:,}",
                                weight="bold",
                            ),
                            width="100%",
                        ),
                        ...
                        rx.hstack(
                            rx.text("当期純利益", weight="bold"),
                            rx.spacer(),
                            rx.text(
                                f"{ReportsState.financial_report.net_income:,}",
                                weight="bold",
                            ),
                            width="100%",
                        ),
                        rx.divider(),
                        rx.hstack(
                            rx.text("純資産合計", weight="bold"),
                            rx.spacer(),
                            rx.text(
                                f"{ReportsState.financial_report.total_equity:,}",
                                weight="bold",
                            ),
                            width="100%",
                        ),
                ...
                rx.vstack(
                    ...
                    rx.hstack(
                        rx.text("売上総利益", weight="bold"),
                        rx.spacer(),
                        rx.text(
                            f"{ReportsState.financial_report.gross_profit:,}",
                            weight="bold",
                        ),
                        width="100%",
                    ),
                    ...
                    rx.hstack(
                        rx.text("営業利益", weight="bold"),
                        rx.spacer(),
                        rx.text(
                            f"{ReportsState.financial_report.operating_income:,}",
                            weight="bold",
                        ),
                        width="100%",
                    ),
                    ...
                    rx.hstack(
                        rx.text("経常利益", weight="bold"),
                        rx.spacer(),
                        rx.text(
                            f"{ReportsState.financial_report.ordinary_income:,}",
                            weight="bold",
                        ),
                        width="100%",
                    ),
                    ...
                    rx.hstack(
                        rx.text("税引前当期純利益", weight="bold"),
                        rx.spacer(),
                        rx.text(
                            f"{ReportsState.financial_report.income_before_tax:,}",
                            weight="bold",
                        ),
                        width="100%",
                    ),
...
def render_section(section: typing.Any) -> rx.Component:
    return rx.vstack(
        ...
        rx.cond(
            section.title.contains("合計")
            | section.title.contains(
                "利益"
            ),  # Not generic but section object has total
            rx.hstack(
                rx.text("合計", font_size="0.8em"),
                rx.spacer(),
                rx.text(f"{section.total:,}"),
                width="100%",
            ),
        ),
        width="100%",
