    ...
    return rx.vstack(
                    ...
                    lambda fy: rx.table.row(
                        ...
                        rx.table.cell(
                            rx.input(
                                ...
                                on_blur=lambda val: FiscalYearState.update_fiscal_year_name(fy.id, val),
                                variant="soft",
                                width="120px"
                            )
                        ),
                            ...
                            rx.hstack(
                                rx.cond(
                                    ...
                                    rx.button(
                                        ...
                                        color_scheme="blue",
                                        size="1",
                                        on_click=lambda: FiscalYearState.open_close_dialog(fy.period_number, fy.id),
        ...
        rx.dialog.root(
            rx.dialog.content(
                ...
                rx.dialog.description("当期の損益を繰越利益剰余金へ振り替え、次年度の期首残高を作成します。"),
                rx.vstack(
