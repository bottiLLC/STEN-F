...
def account_input_row(account) -> rx.Component:
    ...
    return rx.hstack(
        ...
        rx.input(
            ...
            on_change=lambda val: OpeningBSState.update_debit_balance(
                account["id"], val
            ),
            width="180px",
            text_align="right",
        ...
        rx.input(
            ...
            on_change=lambda val: OpeningBSState.update_credit_balance(
                account["id"], val
            ),
            width="180px",
            text_align="right",
                ...
                rx.vstack(
                    rx.card(
                        rx.vstack(
                            ...
                            rx.vstack(
                                rx.foreach(
                                    OpeningBSState.bs_accounts, account_input_row
                                ),
                                width="100%",
                                spacing="0",
                            ),
                            ...
                            rx.hstack(
                                rx.text(
                                    "合計", width="220px", font_weight="bold", size="5"
                                ),
                                rx.text(
                                    OpeningBSState.total_debit.to_string(),
                                    width="180px",
                                    font_weight="bold",
                                    text_align="right",
                                    size="5",
                                ...
                                rx.text(
                                    OpeningBSState.total_credit.to_string(),
                                    width="180px",
                                    font_weight="bold",
                                    text_align="right",
                                    size="5",
                    ...
                    rx.hstack(
                        rx.hstack(
                            ...
                            rx.text(
                                ...
                                color=rx.cond(
                                    OpeningBSState.is_balanced, "green", "red"
                                ),
                                font_weight="bold",
                                size="6",
                            ),
                        ...
                        rx.button(
                            ...
                            style={
                                "opacity": rx.cond(
                                    OpeningBSState.is_balanced, "1", "0.5"
                                )
                            },
                        ),
                        justify="between",
