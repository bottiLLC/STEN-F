...
async def test_extract_receipt_data_image_success(mocker):
    ...
    mock_master_service.get_system_settings = mocker.AsyncMock(return_value=mock_system_settings)
    mock_master_service.get_counterparty_by_keyword = mocker.AsyncMock(return_value=None)
